...
class HunttheWumpus2
{
	public static void main(String [] args) throws IOException
	{
		...
		while(again==1)
		{
			...
			System.out.println("|| Created by Alex Steel. ||");
			int roomplace= 1;
			
			// Put the wumpus into a room
			...
			{	
				...
				if((spider==room[roomplace].getExit1()) || (spider==room[roomplace].getExit2())
					|| (spider==room[roomplace].getExit3())) {System.out.println("You hear a faint tapping noise.");}
				if((pit==room[roomplace].getExit1()) || (pit==room[roomplace].getExit2())
					|| (pit==room[roomplace].getExit3())) {System.out.println("You smell a funky odor!");}
				else{}
				...
				if((choice.equalsIgnoreCase("M")) || (choice.equalsIgnoreCase("S")))
					{
						...
						(L==room[roomplace].getExit3()))
						{
							...
							if(choice.equalsIgnoreCase("M"))
							{
								...
								{
									System.out.println("A colony of bats has transported you to a new room.");
									roomplace=(int)(1+(cavenumber)*Math.random());
										...
										{
											System.out.println("A spider has eaten you.");
											System.out.println("|| You Lose! ||");
											K=1;
										}
										else if(L==pit)
										...
										{
											System.out.println("+3 arrows. Ammo refilled.");
											arrows=3;
											break Sayid;
										}
							...
							{	
								...
								if(arrows==0)
								{
									System.out.println("No... no... You cannot shoot.");
									break Sayid;
								}
								...
								else
								{
									...
									if(L==wumpus)
									{
										System.out.println("Great success! The arrow hits.");
									...
									{
										System.out.println("Your arrow missed.");
										break Sayid;
									}
								}
							}
